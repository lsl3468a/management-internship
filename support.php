  ...
  <body>
  	<header>
		...
		<div id="layout">
			...
			<h1 style="margin-top: 50px;"> Support Magic Web </h1>
      <div id="content" style="min-height : 200px; margin-top : 50px; font-size: 18px;">
       	Pour tout éventuel problème rencontré sur le site, <br>
        veuillez contacter notre service client<a href="mailto:magic.web.stage@gmail.com"> ici</a>.<br>
      	Nous veillerons à traiter votre message dans les plus brefs délais.<br>
        Vos problèmes sont également les notres. <br><br>
        L'équipe Magic Web !
      </div>
